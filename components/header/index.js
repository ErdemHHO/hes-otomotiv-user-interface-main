    ...
    <header className={`${styles.header} header p-1 text-white`}>
      ...
      <div className="container d-none d-xl-flex justify-content-between">
        <div className="d-flex">
          <Image src="/images/brands/bmw.png" alt="BMW" className={styles.logo2} height={60} width={65} />
          <Image src="/images/brands/mini.png" alt="MINI" className={styles.logo2} height={60} width={154} />
        </div>
      ...
      <div className="container d-flex d-xl-none justify-content-between">
        <div className="mt-2 d-flex">
          <Image src="/images/brands/bmw.png" alt="BMW" className={styles.logo2} height={40} width={40} />
